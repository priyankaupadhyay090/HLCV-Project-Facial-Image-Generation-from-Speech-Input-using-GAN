from mainGAN import B_CONDITION
import torch
...
class G_NET(nn.Module):
    ...
    def define_module(self):
        ...
        if BRANCH_NUM > 3:  # Recommended structure (mainly limited by GPU memory), and not test yet
    ...
    def forward(self, z_code, speech_embedding=None):
        if B_CONDITION and speech_embedding is not None:
